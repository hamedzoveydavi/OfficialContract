...
<!-- Mirrored from jobie.dexignzone.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 16:26:52 GMT -->
<head>
         <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Contract Admin Dashboard</title>
    <!-- Favicon icon -->
...
<!--*************************************************************-->
                <div class="block px-4 py-2 text-xs text-gray-400">
                        ...
                        @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                            <a href="{{ route('api-tokens.index') }}" class="dropdown-item ai-icon">
...
<!--*************************************************************-->
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{route('PersonnelList')}}">PersonnelList</a></li>
				...
				<div class="copyright">
					<p><strong>Dashboard</strong> ©All Rights Reserved</p>
					<p>by Hamed Zoveydavi</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Hamed Zoveydavi</a> 2020</p>
            </div>
        </div>
        <!--**********************************
            Footer end
...
<!-- Mirrored from jobie.dexignzone.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 16:28:22 GMT -->
</html>